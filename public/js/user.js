...
$(document).ready(function () {
  ...
  function () {
    ...
    _createClass(User, [{
      ...
      value:
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function userDelete(url) {
        var _this = this;

        var block, tableBody;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function userDelete$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                $.ajax({
                  ...
                  $("tr[data-id=".concat(user.rowId, "]")).remove();

                  if (!tableBody.children().length) {
                    var _block = "<div class=\"jumbotron\">\n                            <h2 class=\"text-muted\">Empty user</h2>\n                        </div>";
                    $(".table").before(_block).remove();
                  }
      ...
      value: function updateUser(url) {
        ...
        $.ajax({
          ...
          success: function success(data) {
            var row = $("tr[data-id=".concat(user.rowId, "]"));
